...
function AccueilEduc({ data, onOpenGroup }) {
  const upcoming = data.groups.slice(0, 2);
  return (
    <div style={{ display: "grid", gap: 16 }}>
      <div style={{ fontFamily: "'Baloo 2', sans-serif", fontSize: 20, color: COLORS.text, fontWeight: 700 }}>Bienvenue Hugo 👋</div>
      ...
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: COLORS.bg, color: COLORS.red, textAlign: "center", padding: 24 }}>
        ...
        <div>
          ...
          <div style={{ color: COLORS.textDim, fontSize: 13, maxWidth: 420 }}>
            Vérifiez que le fichier <code>.env</code> contient bien vos clés Firebase et que les règles Firestore autorisent la lecture/écriture. Détail technique : {String(error.message || error)}
          </div>
        </div>
      </div>
    );
