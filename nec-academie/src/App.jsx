  ...
  return (
    <div style={{ display: "grid", gap: 16, maxWidth: 520 }}>
      ...
      <Card style={{ fontSize: 11, color: COLORS.textDim, fontFamily: "monospace" }}>
        Debug temporaire — rôle de connexion brut : "{role}" (longueur {(role || "").length}) · reconnu comme administrateur général : {isAdminGeneral ? "oui" : "non"} · profil complet : {JSON.stringify(rawProfile)}
      </Card>
